...
from pyopenwebui import Pyopenwebui, AsyncPyopenwebui, APIResponseValidationError
...
def _get_open_connections(client: Pyopenwebui | AsyncPyopenwebui) -> int:
...
class TestPyopenwebui:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "pyopenwebui/_legacy_response.py",
                        "pyopenwebui/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "pyopenwebui/_compat.py",
    ...
    def test_multipart_repeating_array(self, client: Pyopenwebui) -> None:
        request = client._build_request(
    ...
    def test_base_url_trailing_slash(self, client: Pyopenwebui) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Pyopenwebui) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Pyopenwebui) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_omit_retry_count_header(
        self, client: Pyopenwebui, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncPyopenwebui:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncPyopenwebui) -> None:
    ...
    def test_base_url_trailing_slash(self, client: AsyncPyopenwebui) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncPyopenwebui) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncPyopenwebui) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncPyopenwebui, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
