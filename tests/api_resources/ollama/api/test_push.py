...
class TestPush:
    ...
    def test_method_remove(self, client: Pyopenwebui) -> None:
        push = client.ollama.api.push.remove(
            name="name",
        )
    ...
    def test_raw_response_remove(self, client: Pyopenwebui) -> None:
        response = client.ollama.api.push.with_raw_response.remove(
            name="name",
        )
    ...
    def test_streaming_response_remove(self, client: Pyopenwebui) -> None:
        with client.ollama.api.push.with_streaming_response.remove(
            name="name",
        ) as response:
    ...
    def test_method_remove_by_index(self, client: Pyopenwebui) -> None:
        push = client.ollama.api.push.remove_by_index(
            url_idx=0,
            name="name",
        )
        assert_matches_type(object, push, path=["response"])
    ...
    @parametrize
    def test_method_remove_by_index_with_all_params(self, client: Pyopenwebui) -> None:
        push = client.ollama.api.push.remove_by_index(
            url_idx=0,
            name="name",
            insecure=True,
    ...
    def test_raw_response_remove_by_index(self, client: Pyopenwebui) -> None:
        response = client.ollama.api.push.with_raw_response.remove_by_index(
            url_idx=0,
            name="name",
        )
    ...
    def test_streaming_response_remove_by_index(self, client: Pyopenwebui) -> None:
        with client.ollama.api.push.with_streaming_response.remove_by_index(
            url_idx=0,
            name="name",
        ) as response:
            assert not response.is_closed
...
class TestAsyncPush:
    ...
    async def test_method_remove(self, async_client: AsyncPyopenwebui) -> None:
        push = await async_client.ollama.api.push.remove(
            name="name",
        )
        assert_matches_type(object, push, path=["response"])
    ...
    async def test_raw_response_remove(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.ollama.api.push.with_raw_response.remove(
            name="name",
        )
    ...
    async def test_streaming_response_remove(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.ollama.api.push.with_streaming_response.remove(
            name="name",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_remove_by_index(self, async_client: AsyncPyopenwebui) -> None:
        push = await async_client.ollama.api.push.remove_by_index(
            url_idx=0,
            name="name",
        )
        assert_matches_type(object, push, path=["response"])
    ...
    @parametrize
    async def test_method_remove_by_index_with_all_params(self, async_client: AsyncPyopenwebui) -> None:
        push = await async_client.ollama.api.push.remove_by_index(
            url_idx=0,
            name="name",
            insecure=True,
    ...
    async def test_raw_response_remove_by_index(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.ollama.api.push.with_raw_response.remove_by_index(
            url_idx=0,
            name="name",
        )
    ...
    async def test_streaming_response_remove_by_index(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.ollama.api.push.with_streaming_response.remove_by_index(
            url_idx=0,
            name="name",
        ) as response:
            assert not response.is_closed
