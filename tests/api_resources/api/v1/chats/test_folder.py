...
from pyopenwebui.types.api.v1 import ChatResponse
...
class TestFolder:
    ...
    def test_method_update(self, client: Pyopenwebui) -> None:
        folder = client.api.v1.chats.folder.update(
            id="id",
        )
        assert_matches_type(Optional[ChatResponse], folder, path=["response"])
    ...
    def test_raw_response_update(self, client: Pyopenwebui) -> None:
        response = client.api.v1.chats.folder.with_raw_response.update(
            id="id",
        )
    ...
    def test_streaming_response_update(self, client: Pyopenwebui) -> None:
        with client.api.v1.chats.folder.with_streaming_response.update(
            id="id",
        ) as response:
    ...
    def test_path_params_update(self, client: Pyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.api.v1.chats.folder.with_raw_response.update(
                id="",
            )

    @parametrize
    def test_method_get(self, client: Pyopenwebui) -> None:
        folder = client.api.v1.chats.folder.get(
            "folder_id",
        )
    ...
    def test_raw_response_get(self, client: Pyopenwebui) -> None:
        response = client.api.v1.chats.folder.with_raw_response.get(
            "folder_id",
        )
    ...
    def test_streaming_response_get(self, client: Pyopenwebui) -> None:
        with client.api.v1.chats.folder.with_streaming_response.get(
            "folder_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_get(self, client: Pyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `folder_id` but received ''"):
            client.api.v1.chats.folder.with_raw_response.get(
                "",
            )
...
class TestAsyncFolder:
    ...
    async def test_method_update(self, async_client: AsyncPyopenwebui) -> None:
        folder = await async_client.api.v1.chats.folder.update(
            id="id",
        )
        assert_matches_type(Optional[ChatResponse], folder, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.chats.folder.with_raw_response.update(
            id="id",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.chats.folder.with_streaming_response.update(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_update(self, async_client: AsyncPyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.api.v1.chats.folder.with_raw_response.update(
                id="",
            )

    @parametrize
    async def test_method_get(self, async_client: AsyncPyopenwebui) -> None:
        folder = await async_client.api.v1.chats.folder.get(
            "folder_id",
        )
        assert_matches_type(FolderGetResponse, folder, path=["response"])
    ...
    async def test_raw_response_get(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.chats.folder.with_raw_response.get(
            "folder_id",
        )
    ...
    async def test_streaming_response_get(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.chats.folder.with_streaming_response.get(
            "folder_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_get(self, async_client: AsyncPyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `folder_id` but received ''"):
            await async_client.api.v1.chats.folder.with_raw_response.get(
                "",
            )
