...
from pyopenwebui.types.api.v1.chats import PinnedGetResponse, PinnedListResponse
...
class TestPinned:
    ...
    def test_method_list(self, client: Pyopenwebui) -> None:
        pinned = client.api.v1.chats.pinned.list()
        assert_matches_type(PinnedListResponse, pinned, path=["response"])

    @parametrize
    def test_raw_response_list(self, client: Pyopenwebui) -> None:
        response = client.api.v1.chats.pinned.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Pyopenwebui) -> None:
        with client.api.v1.chats.pinned.with_streaming_response.list() as response:
    ...
    def test_method_get(self, client: Pyopenwebui) -> None:
        ...
        assert_matches_type(Optional[PinnedGetResponse], pinned, path=["response"])
    ...
    def test_streaming_response_get(self, client: Pyopenwebui) -> None:
        with client.api.v1.chats.pinned.with_streaming_response.get(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_get(self, client: Pyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.api.v1.chats.pinned.with_raw_response.get(
                "",
            )
...
class TestAsyncPinned:
    ...
    async def test_method_list(self, async_client: AsyncPyopenwebui) -> None:
        pinned = await async_client.api.v1.chats.pinned.list()
        assert_matches_type(PinnedListResponse, pinned, path=["response"])

    @parametrize
    async def test_raw_response_list(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.chats.pinned.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.chats.pinned.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_streaming_response_get(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.chats.pinned.with_streaming_response.get(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_get(self, async_client: AsyncPyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.api.v1.chats.pinned.with_raw_response.get(
                "",
            )
