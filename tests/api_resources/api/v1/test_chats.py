...
class TestChats:
    ...
    @parametrize
    def test_method_pinned(self, client: Pyopenwebui) -> None:
        chat = client.api.v1.chats.pinned(
            "id",
        )
        assert_matches_type(Optional[ChatPinnedResponse], chat, path=["response"])

    @parametrize
    def test_raw_response_pinned(self, client: Pyopenwebui) -> None:
        response = client.api.v1.chats.with_raw_response.pinned(
            "id",
        )
    ...
    @parametrize
    def test_streaming_response_pinned(self, client: Pyopenwebui) -> None:
        with client.api.v1.chats.with_streaming_response.pinned(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @parametrize
    def test_path_params_pinned(self, client: Pyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.api.v1.chats.with_raw_response.pinned(
                "",
            )
...
class TestAsyncChats:
    ...
    @parametrize
    async def test_method_pinned(self, async_client: AsyncPyopenwebui) -> None:
        chat = await async_client.api.v1.chats.pinned(
            "id",
        )
        assert_matches_type(Optional[ChatPinnedResponse], chat, path=["response"])

    @parametrize
    async def test_raw_response_pinned(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.chats.with_raw_response.pinned(
            "id",
        )
    ...
    @parametrize
    async def test_streaming_response_pinned(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.chats.with_streaming_response.pinned(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
