...
class TestSettings:
    ...
    def test_method_update(self, client: Pyopenwebui) -> None:
        setting = client.api.v1.users.user.settings.update()
        assert_matches_type(UserSettings, setting, path=["response"])
    ...
    def test_raw_response_update(self, client: Pyopenwebui) -> None:
        response = client.api.v1.users.user.settings.with_raw_response.update()
    ...
    def test_streaming_response_update(self, client: Pyopenwebui) -> None:
        with client.api.v1.users.user.settings.with_streaming_response.update() as response:
    ...
    def test_method_get(self, client: Pyopenwebui) -> None:
        setting = client.api.v1.users.user.settings.get()
        assert_matches_type(Optional[UserSettings], setting, path=["response"])

    @parametrize
    def test_raw_response_get(self, client: Pyopenwebui) -> None:
        response = client.api.v1.users.user.settings.with_raw_response.get()
    ...
    def test_streaming_response_get(self, client: Pyopenwebui) -> None:
        with client.api.v1.users.user.settings.with_streaming_response.get() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncSettings:
    ...
    async def test_method_update(self, async_client: AsyncPyopenwebui) -> None:
        setting = await async_client.api.v1.users.user.settings.update()
        assert_matches_type(UserSettings, setting, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.users.user.settings.with_raw_response.update()
    ...
    async def test_streaming_response_update(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.users.user.settings.with_streaming_response.update() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_get(self, async_client: AsyncPyopenwebui) -> None:
        setting = await async_client.api.v1.users.user.settings.get()
        assert_matches_type(Optional[UserSettings], setting, path=["response"])

    @parametrize
    async def test_raw_response_get(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.users.user.settings.with_raw_response.get()
    ...
    async def test_streaming_response_get(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.users.user.settings.with_streaming_response.get() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
