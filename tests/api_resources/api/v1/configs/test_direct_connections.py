...
class TestDirectConnections:
    ...
    def test_raw_response_get(self, client: Pyopenwebui) -> None:
        response = client.api.v1.configs.direct_connections.with_raw_response.get()
    ...
    def test_streaming_response_get(self, client: Pyopenwebui) -> None:
        with client.api.v1.configs.direct_connections.with_streaming_response.get() as response:
    ...
    def test_raw_response_set(self, client: Pyopenwebui) -> None:
        response = client.api.v1.configs.direct_connections.with_raw_response.set(
            enable_direct_connections=True,
        )
    ...
    def test_streaming_response_set(self, client: Pyopenwebui) -> None:
        with client.api.v1.configs.direct_connections.with_streaming_response.set(
            enable_direct_connections=True,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncDirectConnections:
    ...
    async def test_raw_response_get(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.configs.direct_connections.with_raw_response.get()
    ...
    async def test_streaming_response_get(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.configs.direct_connections.with_streaming_response.get() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_set(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.configs.direct_connections.with_raw_response.set(
            enable_direct_connections=True,
        )
    ...
    async def test_streaming_response_set(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.configs.direct_connections.with_streaming_response.set(
            enable_direct_connections=True,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
