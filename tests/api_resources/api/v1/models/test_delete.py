...
class TestDelete:
    ...
    def test_method_all(self, client: Pyopenwebui) -> None:
        delete = client.api.v1.models.delete.all()
        assert_matches_type(DeleteAllResponse, delete, path=["response"])

    @parametrize
    def test_raw_response_all(self, client: Pyopenwebui) -> None:
        response = client.api.v1.models.delete.with_raw_response.all()
    ...
    def test_streaming_response_all(self, client: Pyopenwebui) -> None:
        with client.api.v1.models.delete.with_streaming_response.all() as response:
...
class TestAsyncDelete:
    ...
    async def test_method_all(self, async_client: AsyncPyopenwebui) -> None:
        delete = await async_client.api.v1.models.delete.all()
        assert_matches_type(DeleteAllResponse, delete, path=["response"])

    @parametrize
    async def test_raw_response_all(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.models.delete.with_raw_response.all()
    ...
    async def test_streaming_response_all(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.models.delete.with_streaming_response.all() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
