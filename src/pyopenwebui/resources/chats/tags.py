...
from ...types.chats import tag_create_params, tag_delete_params
from ..._base_client import make_request_options
from ...types.chats.chat_id_tag_model import ChatIDTagModel
from ...types.chats.tag_list_response import TagListResponse
from ...types.chats.tag_delete_response import TagDeleteResponse
from ...types.chats.tag_delete_all_response import TagDeleteAllResponse
