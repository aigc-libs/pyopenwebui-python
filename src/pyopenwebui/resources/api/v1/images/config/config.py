...
from ......types.api.v1.images import config_update_params
...
class ConfigResource(SyncAPIResource):
    ...
    def update(
        self,
        *,
        automatic1111: config_update_params.Automatic1111,
        comfyui: config_update_params.Comfyui,
        enabled: bool,
        engine: str,
        gemini: config_update_params.Gemini,
        openai: config_update_params.OpenAI,
...
class ConfigResourceWithRawResponse:
    ...
    def url(self) -> URLResourceWithRawResponse:
        return URLResourceWithRawResponse(self._config.url)
...
class AsyncConfigResourceWithRawResponse:
    ...
    def url(self) -> AsyncURLResourceWithRawResponse:
        return AsyncURLResourceWithRawResponse(self._config.url)
...
class ConfigResourceWithStreamingResponse:
    ...
    def url(self) -> URLResourceWithStreamingResponse:
        return URLResourceWithStreamingResponse(self._config.url)
...
class AsyncConfigResourceWithStreamingResponse:
    ...
    def url(self) -> AsyncURLResourceWithStreamingResponse:
        return AsyncURLResourceWithStreamingResponse(self._config.url)
