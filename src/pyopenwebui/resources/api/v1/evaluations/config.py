...
from .....types.api.v1.evaluations import config_update_params
...
class ConfigResource(SyncAPIResource):
    ...
    def update(
        self,
        *,
        enable_evaluation_arena_models: Optional[bool] | NotGiven = NOT_GIVEN,
        evaluation_arena_models: Optional[Iterable[object]] | NotGiven = NOT_GIVEN,
