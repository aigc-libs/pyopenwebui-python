...
from .......types.api.v1.functions.id import valve_update_params
...
class ValvesResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._post(
            f"/api/v1/functions/id/{id}/valves/update",
    ...
    def get(
        ...
        *,
        ...
        if not id:
            raise ValueError(f"Expected a non-empty value for `id` but received {id!r}")
        return self._get(
            f"/api/v1/functions/id/{id}/valves",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=object,
    ...
    def get_spec(
        ...
        *,
        ...
        if not id:
            raise ValueError(f"Expected a non-empty value for `id` but received {id!r}")
        return self._get(
            f"/api/v1/functions/id/{id}/valves/spec",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=object,
