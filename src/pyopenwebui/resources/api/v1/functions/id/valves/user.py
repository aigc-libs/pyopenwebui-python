...
from .......types.api.v1.functions.id.valves import user_update_params
...
class UserResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._post(
            f"/api/v1/functions/id/{id}/valves/user/update",
    ...
    def get(
        ...
        *,
        ...
        if not id:
            raise ValueError(f"Expected a non-empty value for `id` but received {id!r}")
        return self._get(
            f"/api/v1/functions/id/{id}/valves/user",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=object,
    ...
    def get_spec(
        ...
        *,
        ...
        if not id:
            raise ValueError(f"Expected a non-empty value for `id` but received {id!r}")
        return self._get(
            f"/api/v1/functions/id/{id}/valves/user/spec",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=object,
