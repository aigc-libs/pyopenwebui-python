...
from .....types.api.v1.retrieval import config_update_params
...
class ConfigResource(SyncAPIResource):
    ...
    def update(
        self,
        *,
        bypass_embedding_and_retrieval: Optional[bool] | NotGiven = NOT_GIVEN,
        chunk: Optional[config_update_params.Chunk] | NotGiven = NOT_GIVEN,
        content_extraction: Optional[config_update_params.ContentExtraction] | NotGiven = NOT_GIVEN,
        enable_google_drive_integration: Optional[bool] | NotGiven = NOT_GIVEN,
        enable_onedrive_integration: Optional[bool] | NotGiven = NOT_GIVEN,
        file: Optional[config_update_params.File] | NotGiven = NOT_GIVEN,
        pdf_extract_images: Optional[bool] | NotGiven = NOT_GIVEN,
        rag_full_context: Optional[bool] | NotGiven = NOT_GIVEN,
        web: Optional[config_update_params.Web] | NotGiven = NOT_GIVEN,
        youtube: Optional[config_update_params.Youtube] | NotGiven = NOT_GIVEN,
