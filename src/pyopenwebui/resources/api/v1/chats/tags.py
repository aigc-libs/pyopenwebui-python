...
from .....types.api.v1.chats import tag_add_params, tag_delete_params, tag_get_by_name_params
...
from .....types.api.v1.chats.tag_get_by_name_response import TagGetByNameResponse
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                tag_get_by_name_params.TagGetByNameParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=TagGetByNameResponse,
        )
