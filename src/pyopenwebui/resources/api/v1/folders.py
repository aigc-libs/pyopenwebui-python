...
from ....types.api.v1.folder_model import FolderModel
...
class FoldersResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            "/api/v1/folders/",
            body=maybe_transform({"name": name}, folder_create_params.FolderCreateParams),
    ...
    def update(
        ...
        *,
        ...
        return self._post(
            f"/api/v1/folders/{id}/update/expanded",
            body=maybe_transform({"is_expanded": is_expanded}, folder_update_params.FolderUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=object,
...
class AsyncFoldersResource(AsyncAPIResource):
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            "/api/v1/folders/",
            body=await async_maybe_transform({"name": name}, folder_create_params.FolderCreateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=object,
    ...
    async def update(
        ...
        *,
        ...
        return await self._post(
            f"/api/v1/folders/{id}/update/expanded",
            body=await async_maybe_transform({"is_expanded": is_expanded}, folder_update_params.FolderUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=object,
