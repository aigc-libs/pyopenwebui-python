...
class GroupsResourceWithRawResponse:
    ...
    def id(self) -> IDResourceWithRawResponse:
        return IDResourceWithRawResponse(self._groups.id)
...
class AsyncGroupsResourceWithRawResponse:
    ...
    def id(self) -> AsyncIDResourceWithRawResponse:
        return AsyncIDResourceWithRawResponse(self._groups.id)
...
class GroupsResourceWithStreamingResponse:
    ...
    def id(self) -> IDResourceWithStreamingResponse:
        return IDResourceWithStreamingResponse(self._groups.id)
...
class AsyncGroupsResourceWithStreamingResponse:
    ...
    def id(self) -> AsyncIDResourceWithStreamingResponse:
        return AsyncIDResourceWithStreamingResponse(self._groups.id)
