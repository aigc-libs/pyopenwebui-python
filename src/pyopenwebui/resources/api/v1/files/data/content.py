...
from ......types.api.v1.files.data import content_update_params
...
class ContentResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._post(
            f"/api/v1/files/{id}/data/content/update",
            body=maybe_transform({"content": content}, content_update_params.ContentUpdateParams),
    ...
    def get(
        ...
        *,
        ...
        if not id:
            raise ValueError(f"Expected a non-empty value for `id` but received {id!r}")
        return self._get(
            f"/api/v1/files/{id}/data/content",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=object,
    ...
    async def update(
        ...
        *,
        ...
        return await self._post(
            f"/api/v1/files/{id}/data/content/update",
            body=await async_maybe_transform({"content": content}, content_update_params.ContentUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=object,
