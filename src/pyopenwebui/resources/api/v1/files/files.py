...
from .....types.api.v1 import file_upload_params
from .....types.api.v1.file_model import FileModel
from .....types.api.v1.file_list_response import FileListResponse
from .....types.api.v1.file_model_response import FileModelResponse
...
class FilesResource(SyncAPIResource):
    ...
    def upload(
        ...
        *,
        file: FileTypes,
        file_metadata: object | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
...
class FilesResourceWithRawResponse:
    ...
    def data(self) -> DataResourceWithRawResponse:
        return DataResourceWithRawResponse(self._files.data)
...
class AsyncFilesResourceWithRawResponse:
    ...
    def data(self) -> AsyncDataResourceWithRawResponse:
        return AsyncDataResourceWithRawResponse(self._files.data)
...
class FilesResourceWithStreamingResponse:
    ...
    def data(self) -> DataResourceWithStreamingResponse:
        return DataResourceWithStreamingResponse(self._files.data)
...
class AsyncFilesResourceWithStreamingResponse:
    ...
    def data(self) -> AsyncDataResourceWithStreamingResponse:
        return AsyncDataResourceWithStreamingResponse(self._files.data)
