...
from ...types.api import webhook_update_url_params
...
class WebhookResource(SyncAPIResource):
    ...
    def update_url(
        ...
        *,
        ...
        return self._post(
            "/api/webhook",
            body=maybe_transform({"url": url}, webhook_update_url_params.WebhookUpdateURLParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=object,
    ...
    async def update_url(
        ...
        *,
        ...
        return await self._post(
            "/api/webhook",
            body=await async_maybe_transform({"url": url}, webhook_update_url_params.WebhookUpdateURLParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=object,
...
class WebhookResourceWithRawResponse:
    def __init__(self, webhook: WebhookResource) -> None:
        ...
        self.update_url = to_raw_response_wrapper(
            webhook.update_url,
        )
...
class AsyncWebhookResourceWithRawResponse:
    def __init__(self, webhook: AsyncWebhookResource) -> None:
        ...
        self.update_url = async_to_raw_response_wrapper(
            webhook.update_url,
        )
...
class WebhookResourceWithStreamingResponse:
    def __init__(self, webhook: WebhookResource) -> None:
        ...
        self.update_url = to_streamed_response_wrapper(
            webhook.update_url,
        )
...
class AsyncWebhookResourceWithStreamingResponse:
    def __init__(self, webhook: AsyncWebhookResource) -> None:
        ...
        self.update_url = async_to_streamed_response_wrapper(
            webhook.update_url,
        )
