...
from ...types.api import chat_complete_params, chat_perform_action_params, chat_create_completion_params
...
class ChatResource(SyncAPIResource):
    ...
    def complete(
        ...
        *,
        ...
        return self._post(
            "/api/chat/completed",
            body=maybe_transform(body, chat_complete_params.ChatCompleteParams),
    ...
    def perform_action(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(body, chat_perform_action_params.ChatPerformActionParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=object,
...
class AsyncChatResource(AsyncAPIResource):
    ...
    async def complete(
        ...
        *,
        ...
        return await self._post(
            "/api/chat/completed",
            body=await async_maybe_transform(body, chat_complete_params.ChatCompleteParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=object,
    ...
    async def perform_action(
        ...
        *,
        ...
        return await self._post(
            f"/api/chat/actions/{action_id}",
            body=await async_maybe_transform(body, chat_perform_action_params.ChatPerformActionParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=object,
